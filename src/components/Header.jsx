  ...
  return (
    <div className="w-full lg:flex-row md:flex-row flex flex-col gap-3">
      <div className="lg:w-[68%] md:w-[60%] w-full md:px-0 px-3 flex flex-col gap-5">
        <div className="w-full flex gap-8 justify-between">
          ...
          <div className="flex gap-3">
            <div className="lg:flex md:flex hidden md:p-2 px-3 bg-mobiSearchDark rounded-md flex-col justify-center">
              <Link
                to={organisation ? "/org/settings" : "/app/settings"}
                className="w-full"
              >
                <img src={settings} />
              </Link>
            ...
            <div className="lg:flex md:flex hidden md:p-2 px-3 bg-mobiSearchDark rounded-md flex-col justify-center">
              <Link
                to={organisation ? "/org/notification" : "/app/notification"}
                className="w-full"
              >
        ...
        {greeting ? (
          <div className="w-full flex -mt-1">
            {organisation ? (
              <OrgGreeting orgData={data} />
            ) : (
              <Greeting userData={data} />
            )}
          </div>
        ) : (
          <></>
            ...
            <>
              <div className="w-full flex px-3 gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-mobiRomanSilver">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div
                      ...
                      onClick={() => handleCopy(data.mobiHolderId)}
                    >
                      <svg
                        width="13"
                        height="17"
              ...
              <div className="flex gap-2 px-3 mt-2 mb-2">
                <div className="flex flex-col  gap-1">
                  <p className="text-mobiRomanSilver text-center lg:text-xs md:text-sm sm:text-sm text-xs">
                    Type
                  </p>
                  <p className="text-xs font-[500] text-center">
                    {data.accountType}
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-mobiRomanSilver text-center lg:text-xs md:text-xs sm:text-sm text-xs">
                    Status
                  </p>
                  <p className="text-xs font-[500] text-center">
      ...
      <Drawer open={open} onClose={closeDrawer} className="bg-mobiDarkCloud">
        {organisation ? <OrgSidebar mobile /> : <Sidebar mobile />}
      </Drawer>
    </div>
  );
}
