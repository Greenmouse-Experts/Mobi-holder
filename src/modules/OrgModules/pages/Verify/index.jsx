    ...
    <>
      ...
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile organisation data={user} title={"Verify"} />
          ...
          <div className="w-full md:flex-row flex flex-col md:px-0 px-3 gap-5">
            <StatCard
              ...
              IconComponent={
                <img src={calendar} alt="Events" style={{ width: "20px" }} />
              }
              ...
              {allEvents.length > 0 ? (
                allEvents.map((data, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-center text-mobiTableText">
                      <img width={50} src={data.image} />
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      {data.userId === user.id ? "Me" : "---"}
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      {data.ticketType}
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      {dateFormat(data.startDate, "dd-MM-yyy")}
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      {dateFormat(data.endDate, "dd-MM-yyy")}
                    </td>
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() =>
                                navigate(`/org/view-verifiers/${data.id}`)
                              }
                            >
                              View Verifiers
                            </span>
                          ...
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() =>
                                navigate(`/org/view-event/${data.id}`)
                              }
                            >
                              View Event
                            </span>
          ...
          <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5 my-6">
            <Table
              filter
              subTitle={<span>All Your Verifiers</span>}
              exportData
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() =>
                                navigate(`/org/view-event/${data.event.id}`)
                              }
                            >
                              View Event
                            </span>
