      ...
      <div className="w-full flex flex-col gap-5 h-full">
        ...
        >
          {currentItems.map((subscription, index) => (
            <tr
              key={subscription.id}
              className={index % 2 === 0 ? "bg-mobiDarkCloud" : "bg-mobiTheme"}
            >
              ...
              <td className="px-3 py-3 text-mobiTableText">
                ...
                {subscription.plan?.amount || "N/A"}
              </td>
              <td className="px-3 py-3 text-mobiTableText">
                <Badge
                  status={subscription.status}
                  color={
                    subscription.status === "active" ? "#4CAF50" : "inactive"
                  }
                  textColor={
                    subscription.status === "active" ? "#FFFFFF" : "#000000"
                  }
                />
              </td>
                ...
                <Menu placement="left">
                  ...
                  <MenuList>
                    <MenuItem
                      onClick={() =>
                        navigate(
                          `/org/subscription/plans/view/${subscription.plan?.id}/${subscription.status}`,
                        )
                      }
                    >
                      View Plan
