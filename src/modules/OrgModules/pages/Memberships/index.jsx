...
const UserDetails = ({ closeModal, userInfo, type, reload }) => {
    ...
    const updateMember = (data) => {
        ...
        data.status = type === 'Accept' ? 'active' : blackList ? 'inactive' : 'declined';
...
export default function OrgMembership() {
    ...
    const handleUpdateMember = (data) => {
        openModal({
            size: "sm",
            content: <UpdateMembershipStatusModal closeModal={closeModal} userInfo={data} reload={handleReload} />
        })
    }
            ...
            <div className="w-full flex flex-col gap-5 h-full">
                ...
                <div className="w-full md:flex-row flex flex-col md:px-0 px-3 gap-5">
                    <StatCard
                        ...
                        IconComponent={<svg width="30" height="21" viewBox="0 0 43 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.7861 17.125C19.1601 17.125 20.9111 15.3739 20.9111 13C20.9111 10.6261 19.1601 8.875 16.7861 8.875C14.4122 8.875 12.6611 10.6261 12.6611 13C12.6611 15.3739 14.4101 17.125 16.7861 17.125Z" fill="#79EF6B" />
                            <path d="M38 0.625H5C2.72506 0.625 0.875 2.35956 0.875 4.49219V29.7578C0.875 31.8904 2.72506 33.625 5 33.625H38C40.2749 33.625 42.125 31.8904 42.125 29.7578V4.49219C42.125 2.35956 40.2749 0.625 38 0.625ZM38 29.5L5 29.4773V4.75L38 4.77269V29.5Z" fill="#79EF6B" />
                            <path d="M25.627 10.9375H33.877V15.0625H25.627V10.9375ZM27.6895 19.1875H33.877V23.3125H27.6895V19.1875ZM24.4513 24.418C24.4513 21.5841 20.9946 18.6719 16.7891 18.6719C12.5837 18.6719 9.12695 21.5841 9.12695 24.418V25.375H24.4513V24.418Z" fill="#79EF6B" />
                        </svg>
                        }
                    ...
                    <StatCard
                        ...
                        IconComponent={<svg width="30" height="21" viewBox="0 0 43 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.7861 17.125C19.1601 17.125 20.9111 15.3739 20.9111 13C20.9111 10.6261 19.1601 8.875 16.7861 8.875C14.4122 8.875 12.6611 10.6261 12.6611 13C12.6611 15.3739 14.4101 17.125 16.7861 17.125Z" fill="#EF956B" />
                            <path d="M38 0.625H5C2.72506 0.625 0.875 2.35956 0.875 4.49219V29.7578C0.875 31.8904 2.72506 33.625 5 33.625H38C40.2749 33.625 42.125 31.8904 42.125 29.7578V4.49219C42.125 2.35956 40.2749 0.625 38 0.625ZM38 29.5L5 29.4773V4.75L38 4.77269V29.5Z" fill="#EF956B" />
                            <path d="M25.627 10.9375H33.877V15.0625H25.627V10.9375ZM27.6895 19.1875H33.877V23.3125H27.6895V19.1875ZM24.4513 24.418C24.4513 21.5841 20.9946 18.6719 16.7891 18.6719C12.5837 18.6719 9.12695 21.5841 9.12695 24.418V25.375H24.4513V24.418Z" fill="#EF956B" />
                        </svg>
                        }
                    ...
                    <StatCard
                        ...
                        IconComponent={<svg width="25" height="25" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <td className="px-6 py-3 cursor-pointer">
                                        <Menu placement="left">
                                            ...
                                            <MenuList>
                                                ...
                                                <MenuItem className="flex flex-col gap-3">
                                                    <span className="cursor-pointer" onClick={() => handleUpdateMember(data)}>
                                                        {data.status === 'active' ? 'De-activate Member' : 'Activate Member'}
                                                    </span>
                                                </MenuItem>
                                            </MenuList>
                                        </Menu>
