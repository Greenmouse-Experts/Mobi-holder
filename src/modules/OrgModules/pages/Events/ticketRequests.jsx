...
export default function OrgTicketRequests() {
  ...
  const getTicketRequests = () => {
    mutate({
      url: `/api/events/event/ticket-requests?eventId=${id}`,
      method: "GET",
      headers: true,
      hideToast: true,
      onSuccess: (response) => {
        setTicketRequests(response.data.data);
        setIsLoading(false);
      },
      onError: () => {
        setIsLoading(false);
  ...
  const eventDetailsBlock = [
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M1.3 7.15V8.45H11.7V7.15H1.3ZM3.9 13V9.75H0V0H13V9.75H9.1V13L6.5 11.7L3.9 13ZM1.3 5.2H11.7V1.3H1.3V5.2Z"
            fill="#A1A1A1"
          />
        </svg>
      ),
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M3.61111 7.8C3.40648 7.8 3.23483 7.7376 3.09617 7.6128C2.95798 7.48843 2.88889 7.33417 2.88889 7.15C2.88889 6.96583 2.95798 6.81135 3.09617 6.68655C3.23483 6.56218 3.40648 6.5 3.61111 6.5C3.81574 6.5 3.98739 6.56218 4.12606 6.68655C4.26424 6.81135 4.33333 6.96583 4.33333 7.15C4.33333 7.33417 4.26424 7.48843 4.12606 7.6128C3.98739 7.7376 3.81574 7.8 3.61111 7.8ZM6.5 7.8C6.29537 7.8 6.12396 7.7376 5.98578 7.6128C5.84711 7.48843 5.77778 7.33417 5.77778 7.15C5.77778 6.96583 5.84711 6.81135 5.98578 6.68655C6.12396 6.56218 6.29537 6.5 6.5 6.5C6.70463 6.5 6.87628 6.56218 7.01494 6.68655C7.15313 6.81135 7.22222 6.96583 7.22222 7.15C7.22222 7.33417 7.15313 7.48843 7.01494 7.6128C6.87628 7.7376 6.70463 7.8 6.5 7.8ZM9.38889 7.8C9.18426 7.8 9.01285 7.7376 8.87467 7.6128C8.736 7.48843 8.66667 7.33417 8.66667 7.15C8.66667 6.96583 8.736 6.81135 8.87467 6.68655C9.01285 6.56218 9.18426 6.5 9.38889 6.5C9.59352 6.5 9.76493 6.56218 9.90311 6.68655C10.0418 6.81135 10.1111 6.96583 10.1111 7.15C10.1111 7.33417 10.0418 7.48843 9.90311 7.6128C9.76493 7.7376 9.59352 7.8 9.38889 7.8ZM1.44444 13C1.04722 13 0.707055 12.8728 0.423944 12.6184C0.141315 12.3636 0 12.0575 0 11.7V2.6C0 2.2425 0.141315 1.93657 0.423944 1.6822C0.707055 1.4274 1.04722 1.3 1.44444 1.3H2.16667V0H3.61111V1.3H9.38889V0H10.8333V1.3H11.5556C11.9528 1.3 12.2929 1.4274 12.5761 1.6822C12.8587 1.93657 13 2.2425 13 2.6V11.7C13 12.0575 12.8587 12.3636 12.5761 12.6184C12.2929 12.8728 11.9528 13 11.5556 13H1.44444ZM1.44444 11.7H11.5556V5.2H1.44444V11.7Z"
            fill="#A1A1A1"
          />
        </svg>
      ),
    ...
    },
    {
      icon: (
        ...
        >
          ...
          <path
            d="M2.625 4.82334L10.7496 1L12.0495 4.82334"
            stroke="#15171E"
            strokeWidth="0.7"
            strokeLinecap="round"
          ...
          />
          <path
            d="M1 4.82031H13.9993V7.11431C13.0244 7.11431 12.0494 7.87898 12.0494 9.21715C12.0494 10.5553 13.0244 11.7023 13.9993 11.7023V13.9963H1V11.7023C1.97495 11.7023 2.9499 10.9377 2.9499 9.40832C2.9499 7.87898 1.97495 7.11431 1 7.11431V4.82031Z"
            fill="#A6A6A6"
            stroke="#15171E"
            strokeWidth="0.7"
            strokeLinecap="round"
    ...
    <>
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile organisation data={user} title={"Ticket Requests"} />
          ...
          <div className="w-full flex flex-grow md:flex-row flex-col md:px-0 px-3 justify-between items-start gap-8">
            <div className="shadow-xl py-5 px-5 md:w-[30%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-6">
              ...
              <div className="w-full flex flex-col mt-3 gap-2">
                <div className="w-1/3">
                  <Badge
                    status={`Type : ${eventDetails.status}`}
                    color={`${eventDetails.status || "inactive"}`}
                  />
                </div>
                <div className="w-full my-2 text-mobiRomanSilver">
                  <span className="text-sm">{eventDetails.description}</span>
                </div>
                <div className="flex w-full flex-col gap-5 mt-3">
                  {eventDetailsBlock.map((details, index) => (
                    <div className="w-full flex gap-3" key={`d${index}`}>
            ...
            <div className="shadow-xl md:py-5 md:px-8 px-2 py-2 md:w-[70%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
              <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5 my-6">
                <Table
                  filter
                  subTitle={<span>Ticket Requests</span>}
                  exportData
                            ...
                            <>
                              <span className="flex gap-2">
                                <span
                                  ...
                                  className="flex w-full py-2 cursor-pointer px-5 rounded-full border border-[rgba(247,77,27,1)]"
                                >
                                ...
                                <span
                                  ...
                                  className="flex w-full py-2 cursor-pointer px-5 rounded-full bg-mobiPink"
                                >
