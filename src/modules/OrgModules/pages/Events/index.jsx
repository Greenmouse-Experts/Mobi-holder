...
export default function OrgEvents() {
    ...
    const TableHeaders = ["Event Name", "Event Image", "Category", "Ticket Type", "Attendees", "Verifiers", "Action"];
    const TableData = [
        {
            ...
            <div className="w-full flex h-full animate__animated animate__fadeIn">
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full md:px-0 px-3 md:flex-row flex flex-col gap-5">
                        ...
                        />
                        <Link to={'/org/add-event'} className="bg-mobiDarkCloud cursor-pointer rounded-md shadow-md py-2 px-4 md:w-1/2 flex items-center justify-between">
                                    ...
                                    <td className="px-6 py-3 cursor-pointer">
                                        <Menu placement="left">
                                            ...
                                            <MenuList>
                                                ...
                                                <MenuItem className="flex flex-col gap-3">
                                                    <span className="cursor-pointer" onClick={() => navigate('/org/event-log/2')}>
                                                        Event Log
                                                    </span>
                                                </MenuItem>
