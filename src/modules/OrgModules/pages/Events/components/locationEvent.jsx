        ...
        <>
            <form>
                <div className="mb-1 flex flex-col gap-10 mt-5">
                    ...
                    <div className="w-full flex lg:flex-row md:flex-row flex-col gap-6 mt-6 mb-6">
                        <div className="flex flex-col w-full gap-6">
                            <p className="-mb-3 text-mobiFormGray">
                                Start Date
                            </p>
                    ...
                    <div className="flex flex-col w-full gap-6 mt-6">
                        ...
                        <Input name="phoneNumber" register={register}
                            type="text" placeholder="Choose a reoccurence pattern" />
                    </div>
                    ...
                    <div className="flex flex-col w-full gap-6">
                        ...
                        <Input name="phoneNumber" register={register}
                            type="text" placeholder="Enter numbe rof reoccuring times" />
                    </div>
