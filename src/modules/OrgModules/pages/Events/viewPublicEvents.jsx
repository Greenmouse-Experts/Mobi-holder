...
export default function ViewOrgPublicEvents() {
                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full md:w-3/4 flex justify-between items-center gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            <p className="lg:text-2xl md:text-xl text-lg font-semibold md:hidden">Event Details</p>
                        ...
                        <div className="flex md:w-2/5 w-full justify-end">
                            <Button className="bg-mobiPink" onClick={() => navigate(`/org/order-tickets/${id}`)}>Ticket Request</Button>
                        </div>
                    </div>
