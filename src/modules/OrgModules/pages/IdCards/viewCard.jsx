    ...
    <>
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile organisation data={user} title={"View ID Card"} />
          <div className="w-full flex flex-col gap-8 md:my-5 my-2 px-3">
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex my-2">
                <DropdownMenu
                  buttonLabel={
                    cardData.createdBy === cardData.organization?.id
                      ? "Created By Me"
                      : `Created By ${cardData.individual.firstName} ${cardData.individual.lastName}`
                  }
                  disabled
                  color="#A324F2"
              ...
              <form>
                <div className="mb-1 flex flex-col gap-8 mt-5">
                  ...
                  <div className="flex flex-col w-full mt-10 gap-6">
                    <p className="-mb-3 text-mobiFormGray">Name</p>
                    <Input
                      type="text"
                      name="firstName"
                      value={`${cardData.individual.firstName} ${cardData.individual.lastName}`}
                      register={register}
                      disabled
