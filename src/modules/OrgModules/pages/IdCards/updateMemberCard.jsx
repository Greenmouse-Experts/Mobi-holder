    ...
    <>
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile organisation data={user} title={"ID Card Preview"} />
          <div className="w-full flex flex-col gap-8 md:my-5 my-2 px-3">
            <div className="w-full flex flex-col gap-2">
              ...
              <p className="text-base">
                Preview ID Card for :{" "}
                <span className="text-mobiBlue">Frank Uzo</span>
              </p>
            ...
            <div className="shadow-xl py-5 px-5 md:w-3/4 w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
              <form>
                <div className="mb-1 flex flex-col gap-8 mt-5">
                  ...
                  <div className="flex flex-col w-full gap-6">
                    <p className="-mb-3 text-mobiFormGray">Card Category</p>
                    <Input
                      name="phoneNumber"
                      register={register}
                      type="text"
