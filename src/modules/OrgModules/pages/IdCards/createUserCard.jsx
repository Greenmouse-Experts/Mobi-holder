                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex justify-between items-center gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            <p className="lg:text-2xl md:text-xl text-lg font-semibold">Create ID Card</p>
                            <p className="text-base">Create ID Card for: <span className="text-mobiBlue">Chukka Uzo</span></p>
                        </div>
                    </div>
                            ...
                            <div className="mb-1 flex flex-col gap-5 mt-5">
                                <div className="w-full flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col w-full gap-6">
                                        ...
                                        <Input type="date" name="firstName" register={register}
                                            placeholder="Role" />
                                    </div>
                                    <div className="flex flex-col w-full gap-6">
                                        <p className="-mb-3 text-mobiFormGray">
