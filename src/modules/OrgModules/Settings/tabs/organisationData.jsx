...
export default function OrganisationData() {
    ...
    defaultValues: {
      ...
      address:
        typeof user.companyAddress === "string"
          ? JSON.parse(user.companyAddress).street
          : user.companyAddress.street,
      country:
        typeof user.companyAddress === "string"
          ? JSON.parse(user.companyAddress).country
          : user.companyAddress.country,
      state:
        typeof user.companyAddress === "string"
          ? JSON.parse(user.companyAddress).state
  ...
  const [payload, setPayload] = useState({
    natureOfOrganization: user.natureOfOrganization,
  });
