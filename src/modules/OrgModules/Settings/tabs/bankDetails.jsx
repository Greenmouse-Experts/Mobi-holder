...
export default function BankDetails() {
    ...
    const setAccount = (data) => {
        setIsDisabled(true);
        mutate({
            url: `/api/users/create/subaccount`,
            method: "POST",
            headers: true,
            data: data,
            onSuccess: (response) => {
                ...
                <div className="mb-1 flex flex-col gap-5 mt-5">
                    ...
                    <div className="w-full flex lg:flex-row md:flex-row flex-col gap-6">
                        <div className="flex flex-col w-full gap-6">
                            ...
                            <Input type="text" register={register} name="name" value={orgData.companyName} rules={{ required: 'Business Name is required' }} errors={errors} placeholder="Business Name" />
                        </div>
                    </div>
