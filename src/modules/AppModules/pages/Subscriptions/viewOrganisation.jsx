...
export default function ViewOrganisation() {
    ...
    const eventDetails = [
        ...
        },
        {
            ...
            name: '7 Ikoyi Plaza, Lagos Statev'
        },
    ];
    ...
    const arrayOptions = [
        {
            name: <div className="flex flex-col gap-3">
                ...
                <span className="font-semibold">
                    N 5,000/1 Month</span>
            
                <span className="my-3 text-xs text-mobiRomanSilver">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.
                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex justify-between items-center gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <p className="text-base">Subscribe to: <span className="text-mobiBlue">GreenMouse</span></p>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-grow md:flex-row flex-col md:px-0 px-3 justify-between items-start gap-8">
                        <div className="shadow-xl py-5 px-5 md:w-[30%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-6">
                            <div className="w-full flex justify-center">
                                <img src="/borcelle.png" className="w-3/4 h-full rounded-full" />
                            </div>
                            <div className="w-full flex flex-col mt-3 gap-2">
                                ...
                                <div className="w-full my-2 text-mobiRomanSilver">
                                    <span className="text-sm">Greenmouse is a cutting-edge webdesign firm known for its innovative and sustainable approach to ...read more
                                    </span>
                                </div>
