      ...
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
              ...
              handleExportDataClick={() =>
                exportToExcel(
                  ...
                  receivedRequests.map((item) => [
                    item.eventOwner.companyName
                      ? item.eventOwner.companyName
                      : `${item.eventOwner.firstName} ${item.eventOwner.lastName}`,
                      ...
                      {data.status === "active" ? (
                        ...
                        <span className="flex gap-2">
                          <span
                            ...
                            className="flex py-2 px-3 cursor-pointer rounded-full border border-[rgba(247,77,27,1)]"
                          >
                          ...
                          <span
                            ...
                            className="flex py-2 px-3 cursor-pointer rounded-full bg-mobiPink"
                          >
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() =>
                                navigate(`/app/view-event/${data.eventId}`)
                              }
                            >
                              View Event
                            </span>
          ...
          <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5 my-6">
            <Table
              filter
              subTitle={<span>Initiated Requests</span>}
              exportData
            ...
            >
              {initiatedRequests.length > 0 ? (
                initiatedRequests.map((data, index) => (
                  <tr
                    key={index}
                    className={`py-5 ${index % 2 === 0 ? "bg-mobiDarkCloud" : "bg-mobiTheme"}`}
                  >
