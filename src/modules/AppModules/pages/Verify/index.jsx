            ...
            <div className="w-full flex flex-col gap-5 h-full">
                ...
                <div className="w-full flex flex-col gap-8 md:my-5 my-2 px-3">
                    <div className="w-full flex flex-col gap-2">
                        <p className="lg:text-2xl md:text-xl text-lg font-semibold md:hidden">Verify</p>
                    </div>
                </div>
                ...
                <div className="w-full md:flex-row flex flex-col md:px-0 px-3 gap-5">
                    ...
                    />
                    <Link to={'/app/add-verifiers'} className="bg-mobiDarkCloud rounded-md shadow-md py-2 px-4 md:w-[70%] w-full flex items-center justify-between">
                                    ...
                                    <tr key={index} className={`py-5 ${index % 2 === 0 ? 'bg-mobiDarkCloud' : 'bg-mobiTheme'}`}>
                                        ...
                                        <td className="px-6 py-3 cursor-pointer">
                                            <Menu placement="left">
                                                ...
                                                <MenuList>
                                                    <MenuItem className="flex flex-col gap-3">
                                                        <span className="cursor-pointer" onClick={() => navigate(`/app/view-event/${data.event.id}`)}>
                                                            View Event
                                                        </span>
                                                    </MenuItem>
                                                </MenuList>
