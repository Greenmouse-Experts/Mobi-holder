    ...
    <>
      ...
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile data={user} title={"Verify"} />
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() =>
                                navigate(`/app/view-verifiers/${data.id}`)
                              }
                            >
                              View Verifiers
                            </span>
                          ...
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() =>
                                navigate(`/app/view-event/${data.id}`)
                              }
                            >
                              View Event
                            </span>
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() =>
                                navigate(`/app/view-event/${data.event.id}`)
                              }
                            >
                              View Event
                            </span>
