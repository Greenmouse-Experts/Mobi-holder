                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex justify-between items-center gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <p className="text-base">Manage Verifiers for: <span className="text-mobiBlue">Google UI Event</span></p>
                        </div>
                    </div>
                        ...
                        <div className="shadow-xl md:py-5 md:px-8 px-2 py-2 md:w-[70%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
                            <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5 my-6">
                                <Table title="Today" filter subTitle={<span>Event Verifiers</span>} exportData
                                    ...
                                    tableBtn={<button className="px-2 py-2 flex gap-2 bg-mobiPink text-xs rounded-md" onClick={() => navigate('/app/add-event-verifier/2')}>Add New Verifier</button>}>
