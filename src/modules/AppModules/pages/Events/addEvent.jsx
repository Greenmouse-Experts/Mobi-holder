        ...
        <>
            <div className="w-full flex h-full animate__animated animate__fadeIn">
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex flex-grow flex-col gap-10">
                        <div className="flex flex-col md:w-3/4 w-full sm:flex-row">
                            <button
                        ...
                        <div className="shadow-xl py-5 px-5 md:w-3/4 w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
                            {activeTab === 1 &&
                                <AboutEvent next={() => setActiveTab((prev) => activeTab + 1)} />
                            }
                            {activeTab === 2 &&
                                <LocationEvent next={() => setActiveTab((prev) => activeTab + 1)} />
                            }
                            {activeTab === 3 &&
                                <TicketEvent next={() => setActiveTab((prev) => activeTab + 1)} />
                            }
                        </div>
                    </div>
                </div>
