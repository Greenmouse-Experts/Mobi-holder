      ...
      <form onSubmit={handleSubmit(createEvent)}>
        <div className="mb-1 flex flex-col gap-10 mt-5">
          <div className="flex flex-col w-full gap-6">
            <p className="-mb-3 text-mobiFormGray">Event Name</p>
            <Input
              type="text"
              name="name"
              value={aboutEvents?.name}
          ...
          <div className="flex flex-col w-full gap-6">
            <p className="-mb-3 text-mobiFormGray">Description</p>
            <TextArea
              name="description"
              value={aboutEvents?.description}
              errors={errors}
          ...
          <div className="flex flex-col w-full gap-6">
            <p className="-mb-3 text-mobiFormGray">Event Category</p>
            <Input
              name="category"
              value={aboutEvents?.category}
          ...
          <div className="flex flex-col w-full gap-6">
            ...
            <Input
              name="accessType"
              value={aboutEvents?.accessType}
              register={register}
              rules={{ required: "Event access type is required" }}
              type="select"
              options={accessType}
              placeholder="Choose your Event Access Type"
            />
          </div>
          ...
          <div className="w-full flex lg:flex-row md:flex-row flex-col gap-6">
            <div className="w-full md:w-1/2 flex flex-col gap-2">
              <div className="flex flex-col w-full gap-6">
                <p className="-mb-3 text-mobiFormGray">Event Image</p>
                <DropZone
