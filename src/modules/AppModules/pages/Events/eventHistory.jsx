        ...
        <div className="h-[calc(100dvh-100px)] grid place-items-center">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="opacity-80 text-md">
              {query.error?.response?.data?.messeage}
            </p>
            <button
              ...
              {events.length > 0 ? (
                events.map((data, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-mobiTableText">
                      {/* {JSON.parse(data.venue).name}

                      {JSON.parse(data.venue).address}*/}
                      {data.venue.name}, {data.venue.address}
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      {dateFormat(data.startDate, "dd MMM yyyy")} -{" "}
                      {dateFormat(data.endDate, "dd MMM yyyy")}
                    </td>
                    <td className="px-3 py-3 text-mobiTableText">
                      <Badge status={"Concluded"} color="inactive" />
                    </td>
