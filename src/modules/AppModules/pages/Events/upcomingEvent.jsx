    ...
    <>
      <div className="w-full flex h-full animate__animated animate__fadeIn">
        <div className="w-full flex flex-col gap-5 h-full">
          <Header mobile data={user} title={"Upcoming Events"} />
          <div className="w-full flex flex-col gap-8 md:my-5 my-2 px-3">
            <div className="w-full flex flex-col gap-2">
              <p className="lg:text-2xl md:text-xl text-lg font-semibold md:hidden">
                Upcoming Events
              </p>
              <p className="text-base">All upcoming event</p>
            </div>
          </div>
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() =>
                                navigate(`/app/view-invites/${data.eventId}`)
                              }
                            >
                              Invites
                            </span>
                          ...
                          {data.userId !== user.id && (
                            <MenuItem className="flex flex-col gap-3">
                              <span
                                className="cursor-pointer"
                                onClick={() =>
                                  navigate(`/app/event/view/${data.eventId}`)
                                }
                              >
                                View Details
                              </span>
                            ...
                            <>
                              ...
                              <MenuItem className="flex flex-col gap-3">
                                <span
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/app/ticket-requests/${data.eventId}`,
                                    )
                                  }
                                >
                                  Ticket Requests
                          ...
                          {data.allowVerifierRequests > 0 && (
                            <MenuItem className="flex flex-col gap-3">
                              <span
                                ...
                                onClick={() =>
                                  navigate(
                                    `/app/add-event-verifier/${data.eventId}`,
                                  )
                                }
                              >
                                Add Event Verifier
