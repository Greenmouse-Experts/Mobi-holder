        ...
        <div className="flex gap-5">
          ...
          <div className="flex flex-col gap-2 justify-start">
            <p className="font-semibold text-lg">
              {userInfo.organization.companyName}
            </p>
          ...
          <div className="flex flex-col gap-4 mt-7">
            ...
            <div className="flex flex-col w-full gap-6">
              ...
              <Input
                ...
                disabled
                value={userInfo.organization.companyEmail}
                register={register}
...
export default function Membership() {
  ...
  const handleRequestDecline = (data) => {
    mutate({
      url: `/api/memberships-subscriptions/individual/update/membership/status`,
      method: "PUT",
      headers: true,
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              ...
                              onClick={() => handleViewOrg(data.organization)}
                            >
                              View Organisation
                            </span>
                          </MenuItem>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer size-full"
                              onClick={() => {
                                let id = data.organization.mobiHolderId;
                                navigate("app/membership/edit/" + id);
                              }}
                            >
                              Edit MemberShip
                            </span>
                            ...
                            <>
                              <MenuItem className="flex flex-col gap-3">
                                <span
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `subscriptions/${data.organization.id}`,
                                    )
                                  }
                                >
                              ...
                              <MenuItem className="flex flex-col gap-3">
                                <span
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `subscriptions/history/${data.organization.id}`,
                                    )
                                  }
                                >
                      ...
                      <Menu placement="left">
                        ...
                        <MenuList>
                          <MenuItem className="flex flex-col gap-3">
                            <span
                              className="cursor-pointer"
                              onClick={() => handleRequestDecline(data)}
                            >
                              Decline Request
                            </span>
                          </MenuItem>
