                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex flex-col gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            <p className="lg:text-2xl md:text-xl text-lg font-semibold md:hidden">Generate New Card</p>
                            <p className="text-base">Generate Card from your Organization Template</p>
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSubmit(createCard)}>
                                <div className="mb-1 flex flex-col gap-10 mt-5">
                                    <div className="flex flex-col w-full gap-6">
                                        ...
                                        <Input type="select" name="organization"
                                            register={register}
                                    ...
                                    <div className="flex flex-col w-full gap-6">
                                        ...
                                        <Input type="text" name="designation" register={register} value={designation}
