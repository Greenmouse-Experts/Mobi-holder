  ...
  const navArray = [
    {
      ...
      //   </i>
      // ),
      icon: <HomeIcon size={20} className="mr-2" />,
      children: [],
      openChildren: false,
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-6">
        <Link
          to={"/app/settings"}
          onClick={() => setActiveNav("/app/settings")}
          className={`flex items-center py-2 px-4 h-[57px] rounded-lg ${activeNav === "/app/settings" ? "bg-mobiBlueFade" : "hover:bg-mobiBlueFade"} transition`}
        >
          <i
            className={`fas fa-cog mr-3 ${activeNav === "/app/settings" ? "text-mobiPink" : ""}`}
          ></i>
          <span
            className={`${activeNav === "/app/settings" ? "text-mobiPink" : ""}`}
          >
            Settings
          </span>
        </Link>
        <a
          ...
          className={`flex items-center cursor-pointer py-2 px-4 h-[57px] rounded-lg text-red-500 hover:bg-mobiBlueFade transition`}
        >
