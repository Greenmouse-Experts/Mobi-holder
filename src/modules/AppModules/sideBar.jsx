...
export default function Sidebar() {
    ...
    return (
        <div className={`h-full rounded-md lg:flex md:flex hidden flex-col w-[22%] bg-mobiDarkCloud transition-all custom-scrollbar fixed mb-10`}>
            {/* Logo */}
            ...
            <nav className="px-4 space-y-4">
                ...
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-mobiBlueFade text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22.7 13.5L20.7005 11.5L18.7 13.5M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C15.3019 3 18.1885 4.77814 19.7545 7.42909M12 7V12L15 14" stroke="#7F7F7F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </i>
                    ID Cards
                </a>
                ...
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-mobiBlueFade text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 21H10M18 8C18 6.4087 17.3679 4.88258 16.2427 3.75736C15.1174 2.63214 13.5913 2 12 2C10.4087 2 8.8826 2.63214 7.75738 3.75736C6.63216 4.88258 6.00002 6.4087 6.00002 8C6.00002 11.0902 5.22049 13.206 4.34968 14.6054C3.61515 15.7859 3.24788 16.3761 3.26134 16.5408C3.27626 16.7231 3.31488 16.7926 3.46179 16.9016C3.59448 17 4.19261 17 5.38887 17H18.6112C19.8074 17 20.4056 17 20.5382 16.9016C20.6852 16.7926 20.7238 16.7231 20.7387 16.5408C20.7522 16.3761 20.3849 15.7859 19.6504 14.6054C18.7795 13.206 18 11.0902 18 8Z" stroke="#7F7F7F" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </i>
                    Verify
                </a>
            ...
            <div className="px-4 py-6">
                ...
                <div className="mt-4 flex justify-center space-x-2 p-4">
                    <div className='min-h-[20px] w-full p-2 bg-black flex rounded-lg'>
                        <div className={`h-[30px] w-full ${!darkMode ? 'bg-mobiPink' : ''} rounded-md text-white cursor-pointer flex justify-center py-1`}
                            onClick={() => [setDarkMode(false), document.documentElement.removeAttribute("data-theme")]}>
                            <span className='flex flex-col justify-center'>
                                <svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 1V3M11 19V21M3 11H1M5.31412 5.31412L3.8999 3.8999M16.6859 5.31412L18.1001 3.8999M5.31412 16.69L3.8999 18.1042M16.6859 16.69L18.1001 18.1042M21 11H19M16 11C16 13.7614 13.7614 16 11 16C8.23858 16 6 13.7614 6 11C6 8.23858 8.23858 6 11 6C13.7614 6 16 8.23858 16 11Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                        </div>
                        <div className={`h-[30px] w-full ${darkMode ? 'bg-mobiPink' : ''} rounded-md text-white cursor-pointer flex justify-center py-1`}
                            onClick={() => [setDarkMode(true), document.documentElement.setAttribute("data-theme", "dark")]}
                            >
                            <span className='flex flex-col justify-center'>
                                <svg width="17" height="17" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20.9548 11.9566C19.5779 14.3719 16.9791 16.0003 14 16.0003C9.58172 16.0003 6 12.4186 6 8.00033C6 5.02096 7.62867 2.42199 10.0443 1.04517C4.96975 1.52631 1 5.79961 1 11.0001C1 16.5229 5.47715 21.0001 11 21.0001C16.2002 21.0001 20.4733 17.0308 20.9548 11.9566Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                        </div>
                    </div>
