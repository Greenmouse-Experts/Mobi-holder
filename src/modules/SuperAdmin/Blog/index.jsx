        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden transition-colors duration-300">
            <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{blog.title}</h3>
                    <Menu placement="bottom-end">
                        ...
                        <MenuList className="dark:bg-gray-900 dark:text-gray-100">
                            <MenuItem onClick={() => onEdit(blog)} className="flex items-center gap-2 dark:hover:bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 0L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                                Edit Blog
                            </MenuItem>
                            <MenuItem onClick={() => onDelete(blog)} className="flex items-center gap-2 text-red-500 dark:text-red-400 dark:hover:bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">{formatDate(blog.createdAt)}</p>
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    >
                        ...
                        <span>{isLoading ? (blog ? 'Updating...' : 'Creating...') : (blog ? 'Update Blog Post' : 'Create Blog Post')}</span>
                    </button>
                </div>
            </form>
        </div>
...
const Blog = () => {
    ...
    const openEditModal = (blog) => {
        openModal({
            ...
            content: <BlogEditor blog={blog} onSubmit={handleUpdateBlog} onCancel={closeModal} />
        });
    };
    ...
    const openDeleteModal = (blog) => {
        openModal({
            ...
            content: <DeleteConfirmation blog={blog} onConfirm={handleDeleteBlog} onCancel={closeModal} />
        });
    };
