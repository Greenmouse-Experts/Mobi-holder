...
const OrganisationLog = () => {
    ...
    const TableHeaders = ["Organisation", "Plan", "Validity", "Date Subscribed", "Expiry Date", "Amount", "Status"];
                ...
                <div className="w-full flex flex-col gap-5 border border-mobiBorderFray card-body p-5 rounded-xl my-2">
                    <div className="w-full flex justify-between items-center gap-8 md:mt-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            <p className="lg:text-2xl md:text-xl text-lg font-semibold">Organisation Subscribers</p>
                        </div>
                    </div>
