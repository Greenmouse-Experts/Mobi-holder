...
export default function EventTickets() {
    ...
    const TableHeaders = ["Ticket ID", "Holders Name", "Date", "MHID", "Ticket Type"];
    const TableData = [
        {
            id: 'ASDFH09012',
            name: 'Chukka Uzo',
                ...
                <div className="w-full flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full flex justify-between items-center gap-8 md:my-5 my-2 px-3">
                        <div className="w-full flex flex-col gap-2">
                            <p className="lg:text-2xl md:text-xl text-lg font-semibold">Event Tickets</p>
                    ...
                    <div className="w-full flex flex-grow md:flex-row flex-col md:px-0 px-3 justify-between items-start gap-8">
                        ...
                        <div className="shadow-xl px-2 py-2 md:w-[70%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
                            <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5">
                                <Table title="Today" subTitle={<span>Event Tickets</span>} exportData
                                    hasNumber
                                    transparentBg
                                    tableBtn={
                                    ...
                                    {TableData.map((data, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="px-3 py-5 text-mobiTableText whitespace-normal">{data.type}</td>
                                        </tr>
                                    ))}
                                </Table>
                            </div>
