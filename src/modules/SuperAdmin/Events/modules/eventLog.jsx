...
export default function EventLog() {
    ...
    const eventDetails = [
        {
            ...
            name: '7 Ikoyi Plaza, Admiralty street, Exit busstop, Lagos Statev'
        },
        {
    ...
    const TableHeaders = ["Attendee MBIH", "Attendee Name", "Date", "Time", "Verifiers Name", "Verifiers MBIH"];
    const TableData = [
        {
            id: 'ASDFH09012',
            name: 'Chukka Uzo',
            date: '12-10-24',
            time: '10:00 am',
            verifier: 'Samuel Frank',
            verifierMbih: 'ASDF09043'
        },
        {
            id: 'ASDFH09012',
            name: 'Chukka Uzo',
                    ...
                    <div className="w-full flex flex-grow md:flex-row flex-col md:px-0 px-3 justify-between items-start gap-8">
                        ...
                        <div className="shadow-xl px-2 py-2 md:w-[70%] w-full border border-mobiBorderFray card-body flex rounded-xl flex-col gap-10">
                            <div className="w-full flex lg:flex-row md:flex-row flex-col gap-5">
                                <Table title="Today" subTitle={<span>Event Log</span>} exportData
                                    hasNumber
                                    transparentBg
                                    tableBtn={
                                    ...
                                    {TableData.map((data, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="px-3 py-5 text-mobiTableText whitespace-normal">{data.time}</td>
                                            <td className="px-3 py-5 text-mobiTableText whitespace-normal">{data.verifier}</td>
                                            <td className="px-3 py-5 text-mobiTableText whitespace-normal">{data.verifierMbih}</td>
                                        </tr>
                                    ))}
                                </Table>
                            </div>
