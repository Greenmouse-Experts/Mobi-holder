...
export default function AllPersonalIDCards() {
    ...
    const NewTableHeaders = ["Individual", "Issuing Organisation", "Card Number", "Role", "Issued Date", "Expiry Date", "Action"];
                                            ...
                                            <Menu placement="left">
                                                ...
                                                <MenuList>
                                                    <MenuItem className="flex flex-col gap-3">
                                                        <span className="cursor-pointer" onClick={() => navigate(`view-personal-card/${data.id}`)}>
                                                            View Card
                                                        </span>
                                                    </MenuItem>
                                                </MenuList>
