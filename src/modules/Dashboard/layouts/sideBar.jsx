    ...
    return (
        <div className={`h-full rounded-md lg:flex md:flex hidden flex-col w-[22%] bg-mobiDarkCloud transition-all custom-scrollbar fixed mb-10`}>
            ...
            <nav className="px-4 space-y-4">
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg bg-mobiBlueFade transition`}>
                ...
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-mobiBlueFade text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 21H10M18 8C18 6.4087 17.3679 4.88258 16.2427 3.75736C15.1174 2.63214 13.5913 2 12 2C10.4087 2 8.8826 2.63214 7.75738 3.75736C6.63216 4.88258 6.00002 6.4087 6.00002 8C6.00002 11.0902 5.22049 13.206 4.34968 14.6054C3.61515 15.7859 3.24788 16.3761 3.26134 16.5408C3.27626 16.7231 3.31488 16.7926 3.46179 16.9016C3.59448 17 4.19261 17 5.38887 17H18.6112C19.8074 17 20.4056 17 20.5382 16.9016C20.6852 16.7926 20.7238 16.7231 20.7387 16.5408C20.7522 16.3761 20.3849 15.7859 19.6504 14.6054C18.7795 13.206 18 11.0902 18 8Z" stroke="#7F7F7F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </i>
                    Verify
                </a>
            ...
            <div className="px-4 py-6">
                ...
                <div className="mt-4 flex justify-center space-x-2">
                    <button
                        ...
                        className="p-2 bg-purple-500 text-white rounded-full transition"
                    >
