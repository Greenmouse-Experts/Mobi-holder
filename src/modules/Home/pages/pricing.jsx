    ...
    return (
        <>
            <div className="flex flex-col w-full h-full animate__animated animate__fadeIn">
                ...
                <div className="w-full h-full relative">
                    <div className="w-full h-full flex md:flex-row justify-center flex-col gap-8 md:py-14 py-14 md:px-32 relative" style={{ backgroundColor: 'rgba(249, 247, 243, 1)' }}>
                        ...
                        <div className="min-h-screen bg-[rgba(13,14,29,1)] relative md:rounded-2xl w-full text-white flex flex-col items-center md:py-20 py-5">
                            ...
                            <span className="md:text-5xl text-2xl md:w-[40%] pb-3 my-7 text-center font-bold gradient-text-r md:leading-[70px]">
                            ...
                            <div className="flex flex-col md:mt-10 px-5 w-full md:justify-between md:items-center md:px-20 md:flex-row gap-10">
                                {plans.map((plan) => (
                                    <div
                                        key={plan.name}
                                        className={`p-6 rounded-lg flex flex-col shadow-md w-full max-w-md bg-custom-gradient backdrop-blur-40
                                        ${selectedPlan === plan.name ? 'border border-custom' : ''}`}
                                    >
                                        <div className="mt-3">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-2 font-semibold rounded-full shadow-md ${selectedPlan === plan.name
                                                ? "bg-[rgba(255,43,255,1)] box-pinky text-white"
                                                : "bg-btn-gradient"
                                                }`}
                                        >
                                            Get Started
                                                ...
                                                <li key={index} className="flex gap-2 items-center">
                                                    <span className="w-4 h-4 rounded-full">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12.7131 3.29875C15.3598 5.94542 15.3131 10.2654 12.5798 12.8587C10.0531 15.2521 5.95315 15.2521 3.41981 12.8587C0.679812 10.2654 0.633137 5.94542 3.28647 3.29875C5.88647 0.692083 10.1131 0.692083 12.7131 3.29875Z" stroke="white" stroke-opacity="0.8" stroke-linecap="round" stroke-linejoin="round" />
