                        ...
                        <div className="md:w-11/12 w-full h-full flex flex-col gap-12 py-5 md:px-12 sm:px-6 px-2 rounded-2xl" style={{ backgroundColor: 'rgba(6, 14, 22, 1)' }}>
                            ...
                            <div className="w-full flex flex-col xl:px-10 gap-12">
                                <div className="w-full bg-white py-2 px-4 flex flex-col sm:flex-row justify-between items-center rounded-3xl md:rounded-full space-y-2 sm:space-y-0 sm:space-x-2">
                                    <div className="bg-mobiDarkBlue text-white py-2 sm:py-5 px-4 rounded-full w-full sm:w-auto text-center">
                                        <span className="uppercase text-xs sm:text-base xl:text-lg font-medium">
                                            ID CARD MANAGEMENT
                                        </span>
                                    </div>
                                    <div className="bg-gray-200 text-mobiDarkBlue py-2 sm:py-5 px-4 sm:px-8 rounded-full w-full sm:w-auto text-center">
                                        <span className="uppercase text-xs sm:text-base font-medium">
                                            Event Management
                                        </span>
                                    </div>
                                    <div className="bg-gray-300 text-mobiDarkBlue py-2 sm:py-5 px-4 sm:px-8 rounded-full w-full sm:w-auto text-center">
                                        <span className="uppercase text-xs sm:text-base font-medium">
                                ...
                                <div className="w-full flex md:flex-row md:justify-between md:items-center flex-col gap-10">
                                    <div className="w-full flex">
                                        <div className="w-full md:w-3/4 pb-10 flex flex-col gap-5">
