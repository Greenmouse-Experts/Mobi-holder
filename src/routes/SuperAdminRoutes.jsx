...
const SuperAdminRoutes = [
  ...
  <Route
    path="subscription-organisation/plans"
    element={<OrganisationPlan />}
  />,
  <Route
    path="subscription-individual/plans/create"
    element={<CreatePlan />}
  />,
  <Route
    path="subscription-organisation/plans/create"
    element={<OrgCreatePlan />}
  />,
  <Route
    path="subscription-individual/plans/edit/:id"
    element={<CreatePlan />}
  />,
  <Route
    path="subscription-organisation/plans/edit/:id"
    element={<OrgCreatePlan />}
  />,
  <Route path="subscription-log/individual" element={<IndividualLog />} />,
  <Route path="subscription-log/organisation" element={<OrganisationLog />} />,
  <Route path="personal-idCards" element={<AllPersonalIDCards />} />,
  <Route
    path="personal-idCards/view-personal-card/:id"
    element={<ViewPersonalCard />}
  />,
  ...
  <Route
    path="events/event-attendees/:id/:eventId"
