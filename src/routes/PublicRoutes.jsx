...
import GeneralBlogs from "../modules/General/GeneralBlogs";
import GeneralBlogPage from "../modules/General/GeneralBlogPage";
...
const PublicRoutes = [
  ...
  <Route path="/blogs" element={<GeneralBlogs />} />,
  <Route path="/blogs" element={<GeneralBlogs />} />,
  <Route path="/blogs/:id" element={<GeneralBlogPage />} />,
  // <Route path="/blogs" element={<GeneralBlogs />} />
